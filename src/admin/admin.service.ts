...
export class AdminService {
  ...
  async sendInvite(id: string) {
    ...
    <
          ...
          <ul>
            <li>Click the link to reset the password: <a href="${process.env.FRONTEND_URL}/reset-password/${resetToken}">${process.env.FRONTEND_URL}/reset-password/${resetToken}</a></li>
          </ul>
